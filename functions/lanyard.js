export async function onRequestGet({ env, waitUntil }) {
    ...
    const originSvg = await fetch('https://lanyard.cnrad.dev/api/651943758862090251?showDisplayName=true&bg=0d1117&idleMessage=https://hanakawaii.info').then(r => r.text());
